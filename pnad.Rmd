...
```{r}
tabelateste <- read.table("~/Onedrive/github/PNAD/dados/Acesso a Internet e posse de telefone movel celular/2001/dados/DOM2001.TXT",sep="\t") #extraindo arquivo
...
tabela.PNAD2015 <- read.table("~/Onedrive/github/PNAD/dados/Acesso a Internet e posse de telefone movel celular/2001/dados/PES2015.TXT",sep="\t") #extraindo arquivo
...
```{r}
tab.mort.inf.2011 <- read.csv("~/Dropbox/Ipea/Chamada 17:2018/IDB/Indicadores de mortalidade/mortalidadeinfantil.2000.2011.csv",sep=";",header = FALSE)
